...
import org.opennms.core.ipc.common.aws.sqs.DefaultAmazonSQSManager;
...
public class DefaultAmazonSQSManagerTest {
    ...
    public void testQueueName() {
        ...
        sqsConfig.put(AmazonSQSQueueAttributes.FifoQueue.toString(), "true");
        mgr = getManagerWith(sqsConfig);
    ...
    public void testQueueAttributes() {
        ...
        sqsConfig.put(AmazonSQSQueueAttributes.ContentBasedDeduplication.toString(), "true");
        queueConfig = getSinkQueueConfig(sqsConfig);
        queueAttributes = queueConfig.getAttributes();
        assertThat(queueConfig.isFifoEnabled(), equalTo(true));
        ...
        // Another entry
        sqsConfig.put(AmazonSQSQueueAttributes.Policy.toString(), "a-policy-here");
        queueConfig = getSinkQueueConfig(sqsConfig);
        queueAttributes = queueConfig.getAttributes();
    ...
    private DefaultAmazonSQSManager getManagerWith(Map<String, String> sqsConfig) {
        AmazonSQSConfig config = new AmazonSQSConfigBean(sqsConfig);
